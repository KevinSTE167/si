/* cart.js
 - Muestra los productos guardados en localStorage 'carrito'
 - Permite cambiar cantidad, eliminar, muestra subtotal y total
 - Checkout confirma y exige que e
 */
...
function saveCart(c){ localStorage.setItem('carrito', JSON.stringify(c));
...
// guarda la pagina para redirigir despues
...
renderCart();
// asegúrate que el header cuente productos
window.updateCartCount && window.updateCartCount();
});
